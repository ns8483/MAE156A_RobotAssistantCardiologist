  ...
  while(true) {
    ...
    if (radio.available()) {
      ...
      //look in transmitter code for explanation of this element
        //1 and 2 denote new step size change of servos, 3 is for stepper, 4 is for linear actuator
      ...
      } //controls multiplane buttons
          //servo rotates between pressing each button and neutral positions
      ...
      //look in transmitter code for explanation of this element
        //can save and restore positions
    ...
    radio.stopListening();
    delay(5);
    //writing to controller to update LCD display
